<?php
namespace Ecomo\Factory;

use YPHP\ContainerFactoryInterface;
use YPHP\FilterInputInterface;
use YPHP\SortingInputInterface;
use Ecomo\Activitie;
use Ecomo\ActivitieFilter;

abstract class BaseActivitieFactory implements ContainerFactoryInterface{
